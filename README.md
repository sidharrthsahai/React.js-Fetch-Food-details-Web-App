...
This project was designed and developed by Sidharrth Sahai.
...
Run this command in terminal to install all the package.json files required to run this application.
